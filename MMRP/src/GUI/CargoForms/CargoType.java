...
public class CargoType extends JPanel {
	
	private static final long serialVersionUID = 1L;
	JLabel lblMinCapacity, lblMaxWeight,lblName, lblCargoType, lblID;
	...
	private void update()
	{
		...
		if(errorString.isEmpty())
		{
			if(source==null)
			{
				...
				source.setTrailer1("NONE");
				source.setTrailer2("NONE");
				source.setTravelTypeMode(Vehicle.TravelModes.CARGO.toString());
			}
