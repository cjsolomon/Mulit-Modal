...
public class PlaneType extends JPanel {
	
	private static final long serialVersionUID = 1L;
	JLabel lblMinCapacity, lblMaxWeight,lblName, lblPlaneType, lblID;
	...
	public PlaneType() {
		...
		lblPlaneType = new JLabel("Plane Type");
		lblID = new JLabel("TypeID");
		txtTypeName = new JTextField(20);
		txtID = new JTextField(10);
		
		add(lblPlaneType, "4, 2, center, center");
